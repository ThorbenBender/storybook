...
<Meta 
  ...
  parameters={{
    docs: {
      description: {
        component: 'A customizable country selection component with flag support, form integration, and accessibility features.'
      }
    }
  }}
/>
      ...
      template: `
        <div style="display: flex; flex-direction: column; gap: 20px; align-items: flex-start;">
          <div>
            ...
            <app-country-select size="small"></app-country-select>
          </div>
          <div>
            <label style="display: block; margin-bottom: 8px; font-weight: bold;">Medium</label>
            <app-country-select size="medium"></app-country-select>
          </div>
          <div>
            <label style="display: block; margin-bottom: 8px; font-weight: bold;">Large</label>
            <app-country-select size="large"></app-country-select>
          </div>
        </div>
      `
    }}
...
<ArgsTable of={CountrySelectComponent} />
